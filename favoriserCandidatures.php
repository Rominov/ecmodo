	    ...
	    <div class="container">
	      ...
	      <div class="row">
	      	...
	      	<div class="span12">
				  ...
				  <li class="active"><h3>Ajouter la Candidature aux Favoris</h3></li>
				</ul>
	<form method="post" action="favoriserCandidaturesbdd.php">
 			<p> 
			Vous allez ajouter une candidature aux Favoris/Potentielles. Merci d'écrire pourquoi vous la rajoutez. Quels sont ses atouts....
			<textarea name="commentaire" rows="8" cols="45">
			Points forts de la candidature :
			</textarea>
			<input type="hidden" name="id" value=<?php echo $_GET['id'] ?>>
			<input type="submit" value="Ajouter aux favoris" class="button btn btn-primary" >
			</p>
	</form>
			</div> <!-- /span12 -->          	      	

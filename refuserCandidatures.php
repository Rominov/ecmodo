	    ...
	    <div class="container">
	      ...
	      <div class="row">
	      	...
	      	<div class="span12">
				  ...
				  <li class="active"><h3>Refuser une Candidature</h3></li>
				</ul>
	<form method="post" action="refuserCandidaturesbdd.php">
 			<p> 
			Vous allez ajouter une candidature aux Refus. Merci d'écrire pourquoi vous la rajoutez. Quels sont ses défauts....
			<textarea name="commentaire" rows="8" cols="45">
			Points faibles de la candidature :
			</textarea>
			<input type="hidden" name="id" value=<?php echo $_GET['id'] ?>>
			<input type="submit" value="Refuser la Candidature" class="button btn btn-primary" >
			</p>
	</form>
			</div> <!-- /span12 -->          	      	

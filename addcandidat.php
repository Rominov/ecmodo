	    ...
	    <div class="container">
	      ...
	      <div class="row">
	      	...
	      	<div class="span12">
				  ...
				  <li class="active"><h3>Ajout de Candidats</h3></li>
				</ul>

				<br><center><h1>Formulaire de Rajout de Candidats :</h1></center><br><br>
				
					<form method="post" action="addcandidatbdd.php">
 							<p> 
								Nom du Candidat : <br>
								<input type="text"  name="nom" />
								<br>
								Lien de la Candidature : <br>
								<input type="text"  name="lien" /><br>
								<input type="submit" value="Ajouter Candidat" class="button btn btn-primary" >
							</p> 
					</form>

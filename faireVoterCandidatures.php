	    ...
	    <div class="container">
	      ...
	      <div class="row">
	      	...
	      	<div class="span12">
				  ...
				  <li class="active"><h3>Soummettre la Candidature aux votes</h3></li>
				</ul>
	<form method="post" action="validerCandidaturesbdd.php">
 			<p> 
			Vous allez soummettre une candidature au vote. <b>SEULS LES REFERENTS PEUVENT LE FAIRE !</b> Continuer ?
			<input type="hidden" name="id" value=<?php echo $_GET['id'] ?>>
			<input type="submit" value="Faire Voter" class="button btn btn-primary" >
			</p>
	</form>
			</div> <!-- /span12 -->          	      	
